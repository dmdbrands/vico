...
internal data class CubicPointConnector(private val curvature: Float) :
  ...
  override fun connect(
    ...
    x2: Float,
    y2: Float,
    entry1: com.patrykandpatrick.vico.core.cartesian.data.LineCartesianLayerModel.Entry,
    entry2: com.patrykandpatrick.vico.core.cartesian.data.LineCartesianLayerModel.Entry,
